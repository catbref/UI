...
import {MuteBlockUser} from '../../../../qortal-ui-plugins/plugins/core/components/MuteBlockUser.js'
...
class ChatView extends connect(store)(LitElement) {
    ...
    constructor() {
        super()
        console.log(MuteBlockUser.getBlockedUsers())
        console.log(MuteBlockUser.getMutedUsers())
